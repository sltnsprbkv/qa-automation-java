...
class Application {
    public static void main(String[] args) {
        ...
        orderedDistinctedMessageService.print(new Message("message 1", Severity.MINOR));
        orderedDistinctedMessageService.print(new Message("message 2", Severity.MAJOR), null); // Здесь пропускаем null
        orderedDistinctedMessageService.print(
...
//        MessageService.print(new Message("😎", null)); // Тут выбрасывается исключение
        ...
        System.out.println("\n\n\n");
        orderedDistinctedMessageService.print(MessageOrder.DESC,
        ...
        System.out.println("\n\n\n");
        orderedDistinctedMessageService.print(MessageOrder.DESC, Doubling.DISTINCT,
                new Message("😪", Severity.MINOR),
                new Message("😎" ),
                new Message("😑", Severity.REGULAR),
                new Message("😃", Severity.MAJOR),
